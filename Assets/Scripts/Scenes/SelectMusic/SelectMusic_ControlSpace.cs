...
{
    public class SelectMusicControlSpace : PublicControlSpace
    {
        public static SelectMusicControlSpace instance;
        ...
        private static new IEnumerator Send()
        {
            ...
            SelectMusicUIManager.Instance.SelectMusic(chart.metaData.musicName, chart.metaData.musicWriter, chart.metaData.chartWriter, chart.metaData.artWriter);
